---
id: kb-2026-01-vehicle-subaru-outback
type: finance
status: active
tags: [vehicle, maintenance, asset, subaru]
created: 2026-01-03
updated: 2026-01-03
visibility: private
title: Subaru Outback 2.5i AWD (GE 897423)
---
...
- [decision] {date: 2021-01-03} Switched insurance from Allianz Suisse (Coelvia) to Baloise
...
| Field                   | Value                         |
|-------------------------|-------------------------------|
| **Make & Model**        | Subaru Outback 2.5i AWD       |
| **Body Type**           | Break (Station Wagon)         |
| **Color**               | Gris métallisé (Metallic Grey)|
| **Chassis Number**      | JF1 BP9 LLA 8G0 989 06        |
| **Engine Displacement** | 2457 cm³                      |
| **Power Output**        | 127.0 kW                      |
| **Type Approval**       | 1SC6 91                       |

## Registration Details

| Field                  | Value                        |
|------------------------|------------------------------|
| **License Plate**      | GE 897423                    |
| **Canton**             | Geneva                       |
| **Registration Number**| 627.628.432                  |
| **First Registration** | 31.03.2008                   |
| **Vehicle Category**   | Voiture de tourisme (Code 01)|
...
|--------------------------------|---------|
| **Curb Weight**                | 1600 kg |
| **Payload Capacity**           | 370 kg  |
| **Gross Vehicle Weight**       | 1970 kg |
| **Towing Capacity (braked)**   | 1800 kg |
...
| Field                | Value                                    |
|----------------------|------------------------------------------|
| **Name**             | Rhyne William Logan                      |
| **Address**          | Ch. Champs-de-la-Grange 10, 1252 Meinier |
| **Date of Birth**    | 14.02.1987                               |
| **Country of Origin**| USA                                      |

## Insurance

### Current Provider: Baloise
| Field                       | Value                      |
|-----------------------------|----------------------------|
| **Policy Number**           | 040/8.236.197              |
| **Status**                  | Active                     |

### Previous Provider: Allianz Suisse (Coelvia)
| Field                       | Value                      |
|-----------------------------|----------------------------|
| **Policy Number**           | T30.5.577.411              |
| **Policy Period**           | 02/21/2020 - 01/03/2021    |
| **Insured Value**           | CHF 40,800.00              |
| **Liability Coverage**      | CHF 100,000,000.00         |
| **Deductible**              | CHF 1,000.00               |
| **Annual Premium (Net)**    | CHF 62.00                  |
| **Damage Protection Abroad**| Included                   |
...
#### March 20, 2024 - Tire Installation
**Location:** Annemasse Pneus, 1 Rue des Artisans, 74100 Ville la Grand
**Invoice:** 2020772
**Cost:** CHF 40.00
**Work Performed:**
- Installation of 4 wheels/tires (POSE DE ROUE)

#### July 30, 2020 - Front Brake Pad Replacement
**Location:** Garage des Vollandes SA, Genève
**Invoice:** 148424
**Odometer:** 159,574 km
**Cost:** CHF 303.30
**Work Performed:**
- Front brake pad replacement (REMPLACER PLAQUETTES DE FREINS AVANT)
- Cleaning
...
*Document issued: Geneva, 21.02.2020*

This note tracks all information, decisions, and maintenance for the Subaru Outback. Add observations with `[decision]` tags for maintenance choices, `[question]` for open issues, and update the maintenance history sections as work is performed.
